...
| :--- | :--- | :--- |
| **[Project Name 1](https://github.com/<your-username>/<repo-1>)** | Short 1-sentence description of the problem solved and results achieved. | `Python` `PyTorch` `GEE` |
| **[Project Name 2](https://github.com/<your-username>/<repo-2>)** | Short 1-sentence description highlighting performance / features. | `FastAPI` `React` `Docker` |
| **[Project Name 3](https://github.com/<your-username>/<repo-3>)** | Short 1-sentence description of tools or research paper publication. | `Python` `Pandas` `Scikit-Learn` |
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=<your-username>&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" alt="GitHub Stats" height="160" />
...
<div align="center">
  <sub>⭐️ From [<your-name>](https://github.com/<your-username>) · Let's connect and build something impactful!</sub>
</div>
